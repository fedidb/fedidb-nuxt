<template>
    <header class="sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-colors duration-200">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                <NuxtLink href="/" @click="closeMenu">
                    <div class="flex items-center space-x-2">
                        <div class="h-10 w-10 bg-gradient-to-br from-blue-600 to-sky-500 rounded-lg flex items-center justify-center">
                ...
                <div class="flex items-center space-x-4">
                    <button @click="toggleDarkMode" class="rounded-lg p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <button @click="toggleMenu" class="md:hidden rounded-lg p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors">
            ...
            <div v-if="isMenuOpen" class="md:hidden py-4 border-t border-gray-200 dark:border-gray-700 transition-colors">
