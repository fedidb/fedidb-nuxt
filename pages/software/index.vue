            ...
            <div v-else>
                ...
                <div v-if="viewMode === 'grid'" class="mb-10">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div v-for="(software, index) in paginatedSoftware" :key="index" class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-colors duration-200 hover:shadow-lg cursor-pointer" @click="selectSoftwareById(software.id)">
