    ...
    <div v-else class="min-h-screen dark:bg-gray-900 bg-gray-50">
        <main class="container max-w-6xl mx-auto px-4 py-8 dark:text-white">
            ...
            <div v-if="servers?.length" class="flex justify-between items-center mt-4">
                ...
                <div class="flex space-x-2">
                    <button @click="prevPage" :disabled="page === 1 || isLoading" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed">Previous</button>
